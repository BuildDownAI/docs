...
<Steps>
  ...
  <Step title="Review and merge the workflow pull request">
    Creating the project mapping opens a pull request in your target repo containing `claude-implement.yml`, `claude-plan.yml`, a starter `WORKFLOW.md`, and a starter `PLANNING.md`.
