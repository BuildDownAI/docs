...
<AccordionGroup>
  ...
  <Accordion title="The automated review flagged the pull request">
    ...
    This is a working outcome, not an error — the review did its job. Read the review comment on the pull request: it lists what the review considered unresolved against the original ticket.
