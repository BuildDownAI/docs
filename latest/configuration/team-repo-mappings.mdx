...
<Note>
  ...
  - `workflowFile` — under [Source](#source) below
...
<ParamField body="sensitiveAddPatterns" type="array">
  Extra glob patterns treated as sensitive for this project, on top of the built-in list. A run that stages a matching file is blocked before it commits — see [Blocked by a security guardrail](/latest/reference/run-statuses#blocked-by-a-security-guardrail).
