...
`PLANNING.md` is substituted the same way, and the rules above apply to it too. It takes the common issue fields, plus three describing the issue's place in the tree:
