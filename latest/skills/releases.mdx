...
<Update label="v1.4.0" description="Released 26 August 2026" tags={["Release"]}>
  ...
  **New skills**
  ...
  - **`bd-kg-create`, `bd-kg-refresh`, and `bd-kg-search`** introduce a project knowledge graph: shared memory of past issues, pull requests, and decisions you can query directly. See [BuildDown skills](/latest/skills/introduction#knowledge-graph) for how they fit together.
