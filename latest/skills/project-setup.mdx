...
<Info>
  This assumes the skills are already installed and your session has been reloaded. If you haven't done that yet, start with installation.

  <Card title="Install BuildDown skills" icon="download" href="/latest/skills/installation">
    Add the plugin and reload your session first.
  </Card>
</Info>
...
- **Name the connection per workspace when you run more than one.** If you set up several projects against different workspaces, give each connection a distinct, workspace-specific name so they don't collide.
