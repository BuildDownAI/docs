...
<Steps>
  ...
  <Step title="Issue is picked up and marked In Progress">
    ...
    A separate condition also stops a dispatch: an issue the dispatch breaker has [parked](/latest/reference/admin-ui#parked-issues) after repeated failed dispatches is skipped until an operator unparks it.
