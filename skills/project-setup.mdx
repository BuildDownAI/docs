...
<Steps>
  ...
  <Step title="Sign in">
    ...
    Signing in lasts as long as you keep using the connection: it refreshes itself in the background, and only sends you back to the browser after thirty days idle. The binding itself is unaffected either way.
  </Step>
