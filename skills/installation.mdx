...
Both the marketplace and the plugin are named `builddown`. Installing gives you every `bd-` skill — see [BuildDown skills](/skills/introduction) for what each one does.
...
|---|---|---|
| `BuildDownAI/skills` (no ref) | **Stable** | the most recent released version — see [Releases](/skills/releases) |
