...
<Update label="v1.4.0" description="Released 26 August 2026" tags={["Release"]}>
  ...
  **New skills**
  ...
  - **`bd-kg-create`, `bd-kg-refresh`, and `bd-kg-search`** introduce a project knowledge graph: shared memory of past issues, pull requests, and decisions you can query directly. See [Set up your project](/skills/project-setup) for binding one.
  ...
  **Installation**
  ...
  - The install script installs for **Codex** as well as Claude Code, with `--codex`. See [Install BuildDown skills](/skills/installation#script-options).
</Update>

<Update label="v1.0.0" description="Released 29 July 2026" tags={["Release"]}>
  The first stable release. The suite reached a versioned, installable state — see [BuildDown skills](/skills/introduction) for what it does.

  - **Versioned installation.** A stable channel and a development channel now exist, so you can choose between released versions and ongoing work. [Versions and channels](/skills/installation#versions-and-channels) covers both.
  ...
  <Note>
    If you installed before this release, your channel was recorded on your machine at install time and a new release cannot move you. [Move between channels](/skills/installation#move-between-channels) covers switching, including the caveat that removing a marketplace uninstalls the plugins installed from it.
  </Note>
</Update>
