  ...
  <Step title="Somewhere to run the orchestrator">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Any server running Node.js" icon="server">
        You can run the orchestrator on any server or local machine that has Node.js 20 or later installed. The local development workflow is covered in [Deploy the orchestrator](/latest/setup/deploy).
      </Card>
    </CardGroup>
  </Step>
