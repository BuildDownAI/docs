...
- The gap analysis step always runs on that same model — there is no separate, cheaper default for it, and no front-matter key overrides it.

**Example model IDs for the Anthropic provider:**

```yaml
---
# Use Sonnet for implementation and gap analysis (default)
model: claude-sonnet-4-6
---
```
