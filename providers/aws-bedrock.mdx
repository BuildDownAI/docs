...
Gap analysis always runs on the same `model:` value as implementation, on both providers — there is no separate, cheaper default and no front-matter key overrides it independently.
