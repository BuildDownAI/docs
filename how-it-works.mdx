...
<Steps>
  ...
  <Step title="Planning phase (if enabled)">
    ...
    - **Implementation Map** — the approach, the files to create, modify, test, or delete, and any constraints the implementer must not break
    - **Acceptance Bar** — a numbered list of falsifiable claims the reviewer can check directly against the diff
    - **Risks & Open Questions** — edge cases and unknowns Claude found while exploring the codebase

    <Info>
      When the issue has a parent, siblings, or dependencies, the Implementation Map folds in cross-story coordination notes rather than getting a separate comment.
    </Info>
