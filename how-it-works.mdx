...
<Steps>
  ...
  <Step title="Issue is picked up and marked In Progress">
    ...
    A separate condition also stops a dispatch: an issue the dispatch breaker has [parked](/reference/troubleshooting#an-eligible-issue-stopped-being-dispatched) after repeated failed dispatches is skipped until an operator unparks it.
