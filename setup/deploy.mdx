...
Running locally is the fastest way to test a configuration before committing to a cloud deployment. If this is your first time through, start with the [quickstart](/quickstart); for the full list of settings the orchestrator reads, see [Environment variables](/configuration/environment-variables).
