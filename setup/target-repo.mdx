...
<Steps>
  ...
  <Step title="Review and merge the workflow pull request">
    ...
    <Note>
      The `/ai-implement` PR-comment trigger isn't a synced workflow file — the orchestrator itself handles it directly, once its GitHub App webhook is configured. See [Create a GitHub App](/setup/github-app).
    </Note>
