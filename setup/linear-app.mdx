...
<Note>
  This page applies to Linear. If your project mappings use Jira, configure the Jira credentials on the orchestrator instead — see [Environment variables](/configuration/environment-variables).
</Note>
