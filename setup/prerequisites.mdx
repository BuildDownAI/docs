...
<Steps>
  ...
  <Step title="Node.js 24 (for local development)">
    If you plan to run the orchestrator locally or contribute to the codebase, you need Node.js 24 installed on your machine — `npm run dev` checks the running Node major and refuses to start on any other version. For production Fly.io deployments, Node.js is included in the build — you do not need to install it separately.
  </Step>
</Steps>
