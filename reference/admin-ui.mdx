...
A **Parked issues** section appears on this panel whenever the dispatch circuit breaker has parked at least one issue — after [`DISPATCH_BREAKER_THRESHOLD`](/configuration/environment-variables#param-dispatch-breaker-threshold) consecutive dispatch failures for the same issue and phase, the orchestrator stops picking it up.
